...
namespace IceCreamProject.Controllers
{
    public class IceCreamsController : Controller
    {
        ...
        public IceCreamsController(IceCreamProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Flavor,Price,Temperature,Description,ImgLocation")] IceCream iceCream)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Flavor,Price,Temperature,Description,ImgLocation")] IceCream iceCream)
        {
            if (id != iceCream.Id)
            {
                return NotFound();
